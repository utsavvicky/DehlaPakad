...
if __name__ == "__main__":
	...
	scr_h=500
   	...
   	screen = pygame.display.set_mode((scr_w, scr_h), 0, 32)
    
	# background can be added
   	#BackGround = Background("xxx.jpg", [0,0])
	...
	funcs = {}
   	...
   	menu_items = ('On your own', 'With Friends', 'Tutorial', 'Settings', 'Quit')
 
   	pygame.display.set_caption('Dehla Pakad')
